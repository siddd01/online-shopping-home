          ...
          <div className="mb-8">
            <div className="max-w-2xl">
              <div className="relative flex items-center">
                ...
                />
                <button className="bg-blue-600 hover:bg-blue-700 px-6 py-4 rounded-r-xl border-2 border-blue-600 transition-colors duration-200 flex items-center justify-center ml-2">
                  <img
